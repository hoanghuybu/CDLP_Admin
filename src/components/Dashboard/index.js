...
function DashBoard() {
    ...
    const [series, setSeries] = useState([{ data: [10, 19, 2] }]);
    const navigate = useNavigate();

    const colors = ['#03C3EC', '#71DD37', '#696cff'];
    ...
    useEffect(() => {
        const newSeries = [{ data: [accountTotal, postTotal, staffTotal] }];
        setSeries(newSeries);
    }, [postTotal, accountTotal, staffTotal]);
